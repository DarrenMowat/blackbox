...
-}
test0 :: String -> String
test0 ss = {- In Scope [ ss :: String, Return Type :: String ] -}undefined
...
-}
test1 :: User -> String
test1 (Student s i s2) = {- In Scope [ s :: String, i :: Int, s2 :: String, Return Type :: String ] -} ""
test1 (Admin s i) = ""
...
test2 ss i (i2, sss) = {- In Scope [ ss :: String, i :: Int, i2 :: Int, sss :: [String], Return Type :: Bool ] -}undefined
...
test3 ss i ts = {- In Scope [ ss :: String, i :: Int, ts :: (Int, [String]), Return Type :: Bool ] -}undefined
...
test4 ss i  = {- In Scope [ ss :: String, i :: Int, Return Type :: (Int, [String]) -> Bool ] -}undefined
...
test6 s is = t6inner is == length s 
    where 
      t6inner [] = 0
      t6inner (s1:ss) = {- In Scope [ s :: String, is :: [Int], t6inner :: [t0] -> a0, length :: [a0] -> Int, s1 :: Int, ss :: [t0], Return Type :: Int ] -}1 + t6inner ss
...
test7 s is = t7inner is == length s 
    where 
      t7inner [] = 0
      t7inner (s:ss) = {- In Scope [ s :: Int, is :: [Int], t7inner :: [t0] -> a0, length :: [a0] -> Int, ss :: [t0], Return Type :: Int ] -}1 + t7inner ss
